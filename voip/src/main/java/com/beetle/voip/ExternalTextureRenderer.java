...
public class ExternalTextureRenderer {
  ...
  public void render(int surfaceTextureId, Matrix mat) {
    ...
    float[] transformMat = RendererCommon.convertMatrixFromAndroidGraphicsMatrix(mat);
    ...
    GLES20.glUniformMatrix4fv(textureTransformUniform, 1, false, transformMat, 0);
